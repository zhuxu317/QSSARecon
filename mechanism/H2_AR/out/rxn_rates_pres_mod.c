...
void get_rxn_pres_mod (const double T, const double pres, const double * __restrict__ C, double * __restrict__ pres_mod) {
  ...
  // reaction 6;
  pres_mod[3] = m - 1.0 * C[0] - 1.0 * C[1] - 1.0 * C[2] - 1.0 * C[4] - 1.0 * C[5] - 1.0 * C[6] - 1.0 * C[7] - 1.0 * C[8] - 1.0 * C[9];

  // reaction 7;
  pres_mod[4] = m - 1.0 * C[0] - 1.0 * C[1] - 1.0 * C[2] - 1.0 * C[3] - 1.0 * C[4] - 1.0 * C[6] - 1.0 * C[7] - 1.0 * C[8] - 1.0 * C[9];

  // reaction 8;
  pres_mod[5] = m - 1.0 * C[0] - 1.0 * C[1] - 1.0 * C[2] - 1.0 * C[3] - 1.0 * C[4] - 1.0 * C[5] - 1.0 * C[6] - 1.0 * C[7] - 1.0 * C[9];

  // reaction 10;
  pres_mod[6] = m - 1.0 * C[0] - 1.0 * C[5] - 0.37 * C[8];

  // reaction 11;
  pres_mod[7] = m - 1.0 * C[1] - 1.0 * C[2] - 1.0 * C[3] - 1.0 * C[4] - 1.0 * C[5] - 1.0 * C[6] - 1.0 * C[7] - 1.0 * C[8] - 1.0 * C[9];

  // reaction 12;
  pres_mod[8] = m - 1.0 * C[0] - 1.0 * C[1] - 1.0 * C[2] - 1.0 * C[3] - 1.0 * C[4] - 1.0 * C[6] - 1.0 * C[7] - 1.0 * C[8] - 1.0 * C[9];

  // reaction 13;
  pres_mod[9] = m - 0.27 * C[0] + 2.65 * C[5] - 0.62 * C[8];
