# -*- coding: utf-8 -*-
from utils_pasr import *
from PaSR_models import *
sys.path.append(os.path.abspath('/data/ZhuXu/Cantera/CEMA/mechanism/NH3'))
...
def run_simulation(mech, case, T0, P, eq_ratio, fuel, oxidizer, mix_model="IEM",
    ...
    particle_data = np.empty([num_steps + 1, Np, (gas.n_species + 3)])  # T,P,Y
...
if __name__ == "__main__":
    ...
    plt.savefig("figs/temperature_t.png")
