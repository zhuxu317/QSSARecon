...
def main():
    ...
    directory_path = 'data/case_CH4_counterflow_PP/run_partially_premixed'
    # directory_path = 'data/1D/PP/partially_premixed'
    fig_dir = 'figs/partially-premixed'
    
    # Create the fig_dir if it doesn't exist
    if not os.path.exists(fig_dir):
        os.makedirs(fig_dir)
    
    properties_all = ['T', 'density', 'MF', 'CH4', 'CEM', 'CO2', 'CO', 'H2O', 'N2', 'O2','CH4', 'OH']
